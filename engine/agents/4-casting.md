...
- budget = the reference-images/job number in the "Hard caps" line (use the combined-references number instead when it is smaller), minus 1 when a "Reference budget" line reserves an opening/seam-frame slot;
